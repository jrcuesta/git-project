...
##HUMANS and DOGS
In this case we use the table "space_df"
1- Create a table for all the years and species
```{r}
full_df <- 
 ...
 space_df %>% 
  right_join(full_df, by = c("Year", "Species")) %>% 
   ...
   ggplot(aes(x = Year, y = n_in_space, colour = Species)) +
            geom_line()
```
